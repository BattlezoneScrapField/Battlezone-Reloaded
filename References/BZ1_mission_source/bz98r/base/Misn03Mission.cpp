...
class Misn03Mission : public AiMission {
	DECLARE_RTIME(Misn03Mission)
public:
	Misn03Mission(void);
	~Misn03Mission();
...
void Misn03Mission::AddObject(BZHandle h)
{
	if ((avturret1 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
	{
		avturret1 = h;
	}
	else
	{
		if ((avturret2 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
		{
			avturret2 = h;
		}
		else
		{
			if ((avturret3 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
			{
				avturret3 = h;
			}
			else
			{
				if ((avturret4 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
				{
					avturret4 = h;
				}
				else
				{
					if ((avturret5 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
					{
						avturret5 = h;
					}
					else
					{
						if ((avturret6 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
						{
							avturret6 = h;
						}
						else
						{
							if ((avturret7 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
							{
								avturret7 = h;
							}
							else
							{
								if ((avturret8 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
								{
									avturret8 = h;
								}
								else
								{
									if ((scav3 == BZINVALIDHANDLE) && (IsOdf(h,"avscav")))
									{
										scav3 = h;
									}
									else
									{
										if ((avturret9 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
										{
											avturret9 = h;
										}
										else
										{
											if ((avturret10 == BZINVALIDHANDLE) && (IsOdf(h,"avturr")))
											{
												avturret10 = h;
											}
											else
											{
												if ((scav4 == BZINVALIDHANDLE) && (IsOdf(h,"avscav")))
												{
													scav4 = h;
												}
												else
												{
													if ((scav5 == BZINVALIDHANDLE) && (IsOdf(h,"avscav")))
													{
														scav5 = h;
													}
													else
													{
														if ((scav6 == BZINVALIDHANDLE) && (IsOdf(h,"avscav")))
														{
															scav6 = h;
														}
													}
...
//		Goto(wave4_3, solar2, 1);
	...
	if ((!help_spawn) && (support_time < Get_Time()))
	{
		...
		if ((help_spawn) && (!help_stop1) && (IsAlive(help1)) && (IsAlive(solar2)))
		{
		...
		if ((help_spawn) && (!help_stop2) && (IsAlive(help2)) && (IsAlive(solar2)))
		{
	...
	if ((help_spawn) && (!help_arrive) && ((GetDistance(help1,user) < 50.0f) || (GetDistance(help2,user) < 50.0f)))
	{
...
//			Defend(prop7);
	...
	if ((start_movie) && (!movie_over) && ((CameraCancelled()) || (movie_time < Get_Time() && IsAudioMessageDone(audmsg))))
	{
		CameraFinish();
...
// win/loose conditions	taken out for movie testing
	...
	if ((!startfinishingmovie) && (final_objective))
		...
		if (IsAlive(scav1) && scav1 != user)
		{
			RemoveObject(scav1);
		}
		if (IsAlive(scav2) && scav2 != user)
		{
			RemoveObject(scav2);
		}	
		if (IsAlive(scav3) && scav3 != user)
		{
			RemoveObject(scav3);
		}
		if (IsAlive(scav4) && scav4 != user)
		{
			RemoveObject(scav4);
		}
		if (IsAlive(scav5) && scav5 != user)
		{
			RemoveObject(scav5);
		}
		if (IsAlive(scav6) && scav6 != user)
		{
			RemoveObject(scav6);
		}
		if (IsAlive(avturret1) && avturret1 != user)
		{
			RemoveObject(avturret1);
		}
		if (IsAlive(avturret2) && avturret2 != user)
		{
			RemoveObject(avturret2);
		}
		if (IsAlive(avturret3) && avturret3 != user)
		{
			RemoveObject(avturret3);
		}
		if (IsAlive(avturret4) && avturret4 != user)
		{
			RemoveObject(avturret4);
		}
		if (IsAlive(avturret5) && avturret5 != user)
		{
			RemoveObject(avturret5);
		}
		if (IsAlive(avturret6) && avturret6 != user)
		{
			RemoveObject(avturret6);
		}
		if (IsAlive(avturret7) && avturret7 != user)
		{
			RemoveObject(avturret7);
		}
		if (IsAlive(avturret8) && avturret8 != user)
		{
			RemoveObject(avturret8);
		}
		if (IsAlive(avturret9) && avturret9 != user)
		{
			RemoveObject(avturret9);
		}
		if (IsAlive(avturret10) && avturret10 != user)
		{
			RemoveObject(avturret10);
		}
		if (IsAlive(help1) && help1 != user)
		{
			RemoveObject(help1);
		}
		if (IsAlive(help2) && help2 != user)
		{
			RemoveObject(help2);
		}

		if (IsAlive(wave4_1) && wave4_1 != user)
		{
			RemoveObject(wave4_1);
		}
		if (IsAlive(wave4_2) && wave4_2 != user)
		{
			RemoveObject(wave4_2);
		}
		if (IsAlive(wave6_1) && wave6_1 != user)
		{
			RemoveObject(wave6_1);
		}
		if (IsAlive(wave6_2) && wave6_2 != user)
		{
			RemoveObject(wave6_2);
		}
		if (IsAlive(wave6_3) && wave6_3 != user)
		{
			RemoveObject(wave6_3);
		}
		if (IsAlive(wave7_1) && wave7_1 != user)
		{
			RemoveObject(wave7_1);
		}
		if (IsAlive(wave7_2) && wave7_2 != user)
		{
			RemoveObject(wave7_2);
		}
		if (IsAlive(wave7_3) && wave7_3 != user)
		{
			RemoveObject(wave7_3);
		}
		if (IsAlive(wave7_4) && wave7_4 != user)
		{
			RemoveObject(wave7_4);
		}
		if (IsAlive(wave7_5) && wave7_5 != user)
		{
			RemoveObject(wave7_5);
		}
		if (IsAlive(turret1) && turret1 != user)
		{
			RemoveObject(turret1);
		}
		if (IsAlive(turret2) && turret2 != user)
		{
			RemoveObject(turret2);
		}
		if (IsAlive(turret3) && turret3 != user)
		{
			RemoveObject(turret3);
		}
		if (IsAlive(turret4) && turret4 != user)
		{
...
// win/loose conditions
	...
	if ((!dead1) && (!show_tank_attack) && (!second_objective) && (!IsValid(solar1))) //new
	{
	...
	if ((!dead2) && (!tanks_go) && (!second_objective) && (!IsValid(solar2))) //new
	{
...
void Misn03Mission::AddObject(GameObject *gameObj)
{
	AddObject(gameObj->GetHandle());
	AiMission::AddObject(gameObj);
}

bool Misn03Mission::Load(file fp)
{
	if (missionSave) {
		int i;
...
bool Misn03Mission::Save(file fp)
{
	if (missionSave)
...
const std::set<std::string>& Misn03Mission::GetPreloadSet()
{
