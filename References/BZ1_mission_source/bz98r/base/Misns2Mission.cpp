...
void Misns2Mission::AddObject(BZHandle h)
{
}
...
void Misns2Mission::Execute(void)
{
	...
	*/
		...
		(missionstart == false)
	{
		...
		cam3t = GetTime() + 24.0f;
		cam4t = GetTime() + 34.0f;
		SetObjectiveName(cam1, "Launch Pad");
	}
...
/*	if 
	...
	{
		pat1 = BuildObject ("bvraz", 2, "bdspmain");
		pat2 = BuildObject ("bvraz", 2, "bdspmain");
		patrolsent = true;
		Goto (pat1, "bdnet9");
		Goto (pat2, "bdnet12");
	}
...
const std::set<std::string>& Misns2Mission::GetPreloadSet()
{
