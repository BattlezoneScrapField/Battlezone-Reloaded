...
private:
	...
	*/
	AiPath *path;
	BZHandle pointa,pointb,player,base_handle;
...
public:
	Inst01MissionClass(const char *name) : AiMissionClass(name)
	{
	}
...
const std::set<std::string>& Inst01Mission::GetPreloadSet()
{
