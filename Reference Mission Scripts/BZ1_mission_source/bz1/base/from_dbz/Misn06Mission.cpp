...
void Misn06Mission::Execute(void)
{
	...
	*/
...

	{
		...
		GameObjectHandle :: GetObj(rendezvous) -> SetName ("5th Platoon");
	...
	if
		(IsAlive(star2))
	{
	GameObjectHandle::GetObj(star2)->AddHealth(10000.0f);
	}
	if
		(IsAlive(star6))
	{
	GameObjectHandle::GetObj(star6)->AddHealth(10000.0f);
	}
	if
		(IsAlive(star8))
	{
	GameObjectHandle::GetObj(star8)->AddHealth(10000.0f);
	}
		...
		(opencamdone == true)
	{
		...
		GameObjectHandle::GetObj(p5u3)->AddHealth(50.0f);
		GameObjectHandle::GetObj(p5u4)->AddHealth(50.0f);
		GameObjectHandle::GetObj(p5u6)->AddHealth(50.0f);
		GameObjectHandle::GetObj(p5u9)->AddHealth(50.0f);
		GameObjectHandle::GetObj(p5u12)->AddHealth(50.0f);
	}
		...
		)
	{
		...
		GameObjectHandle :: GetObj(starportcam) ->SetName ("Starport");
		buildcam = false;
		newobjective = true;
	}
		...
		(pickupset == true) 
	{
		...
		GameObjectHandle :: GetObj(dustoffcam) ->SetName ("Dust Off");
		pickupset = false;
		pickupreached = true;
		SetObjectiveOff(launchpad);
	}
