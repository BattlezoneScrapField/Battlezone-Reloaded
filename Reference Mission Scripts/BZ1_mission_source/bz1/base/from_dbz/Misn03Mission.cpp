	...
	if ((IsAlive(solar1)) && (!show_tank_attack))
		{
			...
			{
				GameObjectHandle::GetObj(solar1)->AddHealth(50.0f);
				next_second=GetTime()+1.0f;
			}
		}
...
// win/loose conditions
	...
	if ((!dead1) && (!show_tank_attack) && (!second_objective) && (GameObjectHandle::GetObj(solar1)==NULL)) //new
	{
	...
	if ((!dead2) && (!tanks_go) && (GameObjectHandle::GetObj(solar2)==NULL) && (!second_objective)) //new
	{
