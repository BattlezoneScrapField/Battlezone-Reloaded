...
void Misn10Mission::AddObject(BZHandle h)
{
	...
	{
		if ((ccaartil1 == BZINVALIDHANDLE) && (IsOdf(h,"svartl")))
		{
			ccaartil1 = h;
		}
		else
		{
			if ((ccaartil2 == BZINVALIDHANDLE) && (IsOdf(h,"svartl")))
			{
				ccaartil2 = h;
			}
			else
			{
				if ((ccaartil3 == BZINVALIDHANDLE) && (IsOdf(h,"svartl")))
				{
					ccaartil3 = h;
				}
				else
				{
					if ((ccaturret1 == BZINVALIDHANDLE) && (IsOdf(h,"svturr")))
					{
						ccaturret1 = h;
					}
					else
					{
						if ((ccaturret2 == BZINVALIDHANDLE) && (IsOdf(h,"svturr")))
						{
							ccaturret2 = h;
						}
						else
						{
							if ((ccaturret3 == BZINVALIDHANDLE) && (IsOdf(h,"svturr")))
							{
								ccaturret3 = h;
							}
							else
							{
								if ((ccafighter1 == BZINVALIDHANDLE) && (IsOdf(h,"svfigh")))
								{
									ccafighter1 = h;
								}
								else
								{
									if ((ccafighter2 == BZINVALIDHANDLE) && (IsOdf(h,"svfigh")))
									{
										ccafighter2 = h;
									}
									else
									{
										if ((ccatank1 == BZINVALIDHANDLE) && (IsOdf(h,"svltnk")))
										{
											ccatank1 = h;
										}
										else
										{
											if ((ccatank2 == BZINVALIDHANDLE) && (IsOdf(h,"svltnk")))
											{
												ccatank2 = h;
											}
											else
											{
												if ((ccamuf == BZINVALIDHANDLE) && (IsOdf(h,"svmuf")))
												{
													ccamuf = h;
												}
											}
...
//		relic_check = Get_Time() + 5.0f;
		...
		SetObjectiveName(nav2, "CCA Base");
		SetObjectiveName(nav3, "Drop Zone");
...
const std::set<std::string>& Misn10Mission::GetPreloadSet()
{
