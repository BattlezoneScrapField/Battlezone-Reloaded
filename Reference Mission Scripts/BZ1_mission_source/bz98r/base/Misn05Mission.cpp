	...
	union {
		struct {
			bool
				...
				mine20built, mine21built, mine22built, mine23built, mine24built, attackcmd, 
	...
	union {
		struct {
			float
				...
				mine21, mine22, mine23, mine24, bombtime, lemcinstart, lemcinend,
	...
	union {
		struct {
			BZHandle
				...
				MINE18, MINE19, MINE20, MINE21, MINE22, MINE23, MINE24,
...
void Misn05Mission::Execute(void)
{
	...
	*/
	...
	if (mine1built)
	{
		BZHandle meat = GetNearestVehicle ("path_1" ,1);
	...
	else
	{
		if (mine1 < GetTime()) {
			...
			if (GetDistance(meat, "path_1") < 400.0f)
			{
				MINE1 = BuildObject ("boltmine", 2, "path_1");
				mine1built = true;
			}
		}
	}
	if (mine2built)
	{
		BZHandle meat = GetNearestVehicle ("path_2" ,1);
	...
	else
	{
		if (mine2 < GetTime()) {
			...
			if (GetDistance(meat, "path_2") < 400.0f)
			{
				MINE2 = BuildObject ("boltmine", 2, "path_2");
				mine2built = true;
			}
		}
	}
	if (mine3built)
	{
		BZHandle meat = GetNearestVehicle ("path_3" ,1);
	...
	else
	{
		if (mine3 < GetTime()) {
			...
			if (GetDistance(meat, "path_3") < 400.0f)
			{
				MINE3 = BuildObject ("boltmine", 2, "path_3");
				mine3built = true;
			}
		}
	}
	...
	if (mine4built)
	{
		BZHandle meat = GetNearestVehicle ("path_4" ,1);
	...
	else
	{
		if (mine4 < GetTime()) {
			...
			if (GetDistance(meat, "path_4") < 400.0f)
			{
				MINE4 = BuildObject ("boltmine", 2, "path_4");
				mine4built = true;
			}
		}
	}
	if (mine5built)
	{
		BZHandle meat = GetNearestVehicle ("path_5" ,1);
	...
	else
	{
		if (mine5 < GetTime()) {
			...
			if (GetDistance(meat, "path_5") < 400.0f)
			{
				MINE5 = BuildObject ("boltmine", 2, "path_5");
				mine5built = true;
			}
		}
	}
	...
	if (mine6built)
	{
		BZHandle meat = GetNearestVehicle ("path_6" ,1);
	...
	else
	{
		if (mine6 < GetTime()) {
			...
			if (GetDistance(meat, "path_6") < 400.0f)
			{
				MINE6 = BuildObject ("boltmine", 2, "path_6");
				mine6built = true;
			}
		}
	}
	...
	if (mine7built)
	{
		BZHandle meat = GetNearestVehicle ("path_7" ,1);
	...
	else
	{
		if (mine7 < GetTime()) {
			...
			if (GetDistance(meat, "path_7") < 400.0f)
			{
				MINE7 = BuildObject ("boltmine", 2, "path_7");
				mine7built = true;
			}
		}
	}
	...
	if (mine8built)
	{
		BZHandle meat = GetNearestVehicle ("path_8" ,1);
	...
	else
	{
		if (mine8 < GetTime()) {
			...
			if (GetDistance(meat, "path_8") < 400.0f)
			{
				MINE8 = BuildObject ("boltmine", 2, "path_8");
				mine8built = true;
			}
		}
	}
	...
	if (mine9built)
	{
		BZHandle meat = GetNearestVehicle ("path_9" ,1);
	...
	else
	{
		if (mine9 < GetTime()) {
			...
			if (GetDistance(meat, "path_9") < 400.0f)
			{
				MINE9 = BuildObject ("boltmine", 2, "path_9");
				mine9built = true;
			}
		}
	}
	...
	if (mine10built)
	{
		BZHandle meat = GetNearestVehicle ("path_10" ,1);
	...
	else
	{
		if (mine10 < GetTime()) {
			...
			if (GetDistance(meat, "path_10") < 400.0f)
			{
				MINE10 = BuildObject ("boltmine", 2, "path_10");
				mine10built = true;
			}
		}
	}
	...
	if (mine11built)
	{
		BZHandle meat = GetNearestVehicle ("path_11" ,1);
	...
	else
	{
		if (mine11 < GetTime()) {
			...
			if (GetDistance(meat, "path_11") < 400.0f)
			{
				MINE11 = BuildObject ("boltmine", 2, "path_11");
				mine11built = true;
			}
		}
	}
	...
	if (mine12built)
	{
		BZHandle meat = GetNearestVehicle ("path_12" ,1);
	...
	else
	{
		if (mine12 < GetTime()) {
			...
			if (GetDistance(meat, "path_12") < 400.0f)
			{
				MINE12 = BuildObject ("boltmine", 2, "path_12");
				mine12built = true;
			}
		}
	}
	...
	if (mine13built)
	{
		BZHandle meat = GetNearestVehicle ("path_13" ,1);
	...
	else
	{
		if (mine13 < GetTime()) {
			...
			if (GetDistance(meat, "path_13") < 400.0f)
			{
				MINE13 = BuildObject ("boltmine", 2, "path_13");
				mine13built = true;
			}
		}
	}
	...
	if (mine14built)
	{
		BZHandle meat = GetNearestVehicle ("path_14" ,1);
	...
	else
	{
		if (mine14 < GetTime()) {
			...
			if (GetDistance(meat, "path_14") < 400.0f)
			{
				MINE14 = BuildObject ("boltmine", 2, "path_14");
				mine14built = true;
			}
		}
	}
	...
	if (mine15built)
	{
		BZHandle meat = GetNearestVehicle ("path_15" ,1);
	...
	else
	{
		if (mine15 < GetTime()) {
			...
			if (GetDistance(meat, "path_15") < 400.0f)
			{
				MINE15 = BuildObject ("boltmine", 2, "path_15");
				mine15built = true;
			}
		}
	}
	...
	if (mine16built)
	{
		BZHandle meat = GetNearestVehicle ("path_16" ,1);
	...
	else
	{
		if (mine16 < GetTime()) {
			...
			if (GetDistance(meat, "path_16") < 400.0f)
			{
				MINE16 = BuildObject ("boltmine", 2, "path_16");
				mine16built = true;
			}
		}
	}
	...
	if (mine17built)
	{
		BZHandle meat = GetNearestVehicle ("path_17" ,1);
	...
	else
	{
		if (mine17 < GetTime()) {
			...
			if (GetDistance(meat, "path_17") < 400.0f)
			{
				MINE17 = BuildObject ("boltmine", 2, "path_17");
				mine17built = true;
			}
		}
	}
	...
	if (mine18built)
	{
		BZHandle meat = GetNearestVehicle ("path_18" ,1);
	...
	else
	{
		if (mine18 < GetTime()) {
			...
			if (GetDistance(meat, "path_18") < 400.0f)
			{
				MINE18 = BuildObject ("boltmine", 2, "path_18");
				mine18built = true;
			}
		}
	}
	...
	if (mine19built)
	{
		BZHandle meat = GetNearestVehicle ("path_19" ,1);
	...
	else
	{
		if (mine19 < GetTime()) {
			...
			if (GetDistance(meat, "path_19") < 400.0f)
			{
				MINE19 = BuildObject ("boltmine", 2, "path_19");
				mine19built = true;
			}
		}
	}
	...
	if (mine20built)
	{
		BZHandle meat = GetNearestVehicle ("path_20" ,1);
	...
	else
	{
		if (mine20 < GetTime()) {
			...
			if (GetDistance(meat, "path_20") < 400.0f)
			{
				MINE20 = BuildObject ("boltmine", 2, "path_20");
				mine20built = true;
			}
		}
	}
	...
	if (mine21built)
	{
		BZHandle meat = GetNearestVehicle ("path_21" ,1);
	...
	else
	{
		if (mine21 < GetTime()) {
			...
			if (GetDistance(meat, "path_21") < 400.0f)
			{
				MINE21 = BuildObject ("boltmine", 2, "path_21");
				mine21built = true;
			}
		}
	}
	...
	if (mine22built)
	{
		BZHandle meat = GetNearestVehicle ("path_22" ,1);
	...
	else
	{
		if (mine22 < GetTime()) {
			...
			if (GetDistance(meat, "path_22") < 400.0f)
			{
				MINE22 = BuildObject ("boltmine", 2, "path_22");
				mine22built = true;
			}
		}
	}
	...
	if (mine23built)
	{
		BZHandle meat = GetNearestVehicle ("path_23" ,1);
	...
	else
	{
		if (mine23 < GetTime()) {
			...
			if (GetDistance(meat, "path_23") < 400.0f)
			{
				MINE23 = BuildObject ("boltmine", 2, "path_23");
				mine23built = true;
			}
		}
	}
	...
	if (mine24built)
	{
		BZHandle meat = GetNearestVehicle ("path_24" ,1);
		if (GetDistance(meat, "path_24") > 400.0f)
		{
			mine24 = GetTime() + 3.0f;
			mine24built = false;
			RemoveObject (MINE24);
	...
	else
	{
		if (mine24 < GetTime()) {
			...
			if (GetDistance(meat, "path_24") < 400.0f)
			{
				MINE24 = BuildObject ("boltmine", 2, "path_24");
				mine24built = true;
			}
		}
	}
...
const std::set<std::string>& Misn05Mission::GetPreloadSet()
{
