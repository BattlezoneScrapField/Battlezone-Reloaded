...
private:
	...
	union {
		struct {
			int32_t
				units, scrap, tanks, defense1, defense2,
...
void Misns8Mission::AddObject(BZHandle h)
{
	if ((avturret1 == BZINVALIDHANDLE) && (IsOdf(h,"bvtur8")))
	{
		avturret1 = h;
	}
	else if ((avturret2 == BZINVALIDHANDLE) && (IsOdf(h,"bvtur8")))
	{
		avturret2 = h;
	}
	else if ((avfighter1 == BZINVALIDHANDLE) && (IsOdf(h,"bvra8")))
	{
		avfighter1 = h;
	}
	else if ((avfighter2 == BZINVALIDHANDLE) && (IsOdf(h,"bvra8")))
	{
		avfighter2 = h;
	}
	else if ((avrig1 == BZINVALIDHANDLE) && (IsOdf(h,"avcns8")))
	{
		avrig1 = h;
	}
	else if ((avrig2 == BZINVALIDHANDLE) && (IsOdf(h,"avcns8")))
	{
		avrig2 = h;
	}
	else if ((avtank1 == BZINVALIDHANDLE) && (IsOdf(h,"bvtavk")))
	{
		avtank1 = h;
	}
	else if ((avtank2 == BZINVALIDHANDLE) && (IsOdf(h,"bvtavk")))
	{
		avtank2 = h;
	}
	else if ((avtank3 == BZINVALIDHANDLE) && (IsOdf(h,"bvtavk")))
	{
		avtank3 = h;
	}
	else if ((avtower1 == BZINVALIDHANDLE) && (IsOdf(h,"abtowe")))
	{
		avtower1 = h;
	}
	else if ((avtower2 == BZINVALIDHANDLE) && (IsOdf(h,"abtowe")))
	{
		avtower2 = h;
	}
	else if ((avpower1 == BZINVALIDHANDLE) && (IsOdf(h,"abwpow")))
	{
		avpower1 = h;
	}
	else if ((avpower2 == BZINVALIDHANDLE) && (IsOdf(h,"abwpow")))
	{
		avpower2 = h;
	}
	else if ((avtower3 == BZINVALIDHANDLE) && (IsOdf(h,"abtowe")))
	{
		avtower3 = h;
	}
	else if ((avtower4 == BZINVALIDHANDLE) && (IsOdf(h,"abtowe")))
	{
		avtower4 = h;
	}
	else if ((avpower3 == BZINVALIDHANDLE) && (IsOdf(h,"abwpow")))
	{
		avpower3 = h;
	}
	else if ((avpower4 == BZINVALIDHANDLE) && (IsOdf(h,"abwpow")))
	{
		avpower4 = h;
	}
	else if ((avsilo1 == BZINVALIDHANDLE) && (IsOdf(h,"absilo")))
	{
		avsilo1 = h;
	}
	else if ((avsilo2 == BZINVALIDHANDLE) && (IsOdf(h,"absilo")))
	{
		avsilo2 = h;
	}
	else if ((screwtower == BZINVALIDHANDLE) && (IsOdf(h,"abtowe")))
	{
		screwtower = h;
	}
	else if ((screwpower == BZINVALIDHANDLE) && (IsOdf(h,"abwpow")))
	{
		screwpower = h;
	}
	else if ((svpower1 == BZINVALIDHANDLE) && (IsOdf(h,"sbwpow")))
	{
		svpower1 = h;
	}
	else if ((svpower2 == BZINVALIDHANDLE) && (IsOdf(h,"sbwpow")))
	{
		svpower2 = h;
	}
	else if ((avturret3 == BZINVALIDHANDLE) && (IsOdf(h,"bvtur8")))
	{
		avturret3 = h;
	}
	else if ((avturret4 == BZINVALIDHANDLE) && (IsOdf(h,"bvtur8")))
	{
		avturret4 = h;
	}
	else if ((avbomb1 == BZINVALIDHANDLE) && (IsOdf(h,"bvhraz")))
	{
		avbomb1 = h;
	}
	else if ((avapc1 == BZINVALIDHANDLE) && (IsOdf(h,"bvapc")))
	{
		avapc1 = h;
	}
	else if ((sav1 == BZINVALIDHANDLE) && (IsOdf(h,"savtnk")))
	{
		sav1 = h;
	}
	else if ((sav2 == BZINVALIDHANDLE) && (IsOdf(h,"savtnk")))
	{
		sav2 = h;
	}
	else if ((sav3 == BZINVALIDHANDLE) && (IsOdf(h,"savtnk")))
	{
		sav3 = h;
	}
	else if ((sav4 == BZINVALIDHANDLE) && (IsOdf(h,"savtnk")))
	{
		sav4 = h;
	}
	else if ((sav5 == BZINVALIDHANDLE) && (IsOdf(h,"savtnk")))
	{
		sav5 = h;
	}
	else if ((sav6 == BZINVALIDHANDLE) && (IsOdf(h,"savtnk")))
	{
		sav6 = h;
	}
	else if ((avwalker == BZINVALIDHANDLE) && (IsOdf(h,"bvwalk")))
	{
		avwalker = h;
	}
}
...
//		AddObjective("misns800.otf", WHITE);
		...
		SetObjectiveName(cam2, "Drop Zone");
	...
	if ((!warning) && (convoy_start) && (IsAlive(avmuf)) && (muf_warning < Get_Time()))
	{
		...
		else
		{
			if (GetDistance(avmuf, dis_geyser1) < 100.0f)
			{
				...
				SetObjectiveName(cam3, "Choke Point");
				ClearObjectives();
				AddObjective("misns800.otf", WHITE);
...
/*
		if ((GetDistance(avrecycle, dis_geyser2) < 100.0f) && (!recycle_message))
		{
			...
			SetObjectiveName(cam4, "Choke Point");
...
// this determines who shot him
	...
	if ((!player_payback) && (!sav_payback))
	{
		...
		if (IsAlive(key_tank))
		{
			...
			int shot_by = GetWhoShotMe(key_tank);
	...
	if ((sav_payback) && (!general_message3) && (IsAlive(key_tank)) && 
		(GetHealth(key_tank) < 0.80f) && (!general_message2))
	{
		AudioMessage("misns817.wav");
...
const std::set<std::string>& Misns8Mission::GetPreloadSet()
{
